...
Batroun with the lights out. The same ember and gold on near-black.

One of four themes in **Levantine Sunset** — two places, each at two depths.
Ember and gold on a blue-leaning near-black base.

![Batroun Noir](preview.png)

## Install

```sh
omarchy theme install https://github.com/gaius-codius/omarchy-batroun-noir-theme
```

Then pick it from the theme menu, or `omarchy theme set "Batroun Noir"`.
...
![Batroun Noir wallpapers](wallpapers.jpg)
...
`~/.config/omarchy/backgrounds/batroun-noir/`.


## Boot and login screen

![Batroun Noir boot and login screen](preview-unlock.png)
...
```sh
omarchy plymouth set by theme batroun-noir
```
...
```sh
omarchy plymouth preview '#080A0E' '#EDE3D6' unlock.png /tmp/preview.png
```
...
[Batroun](https://github.com/gaius-codius/omarchy-batroun-theme) · [Beirut](https://github.com/gaius-codius/omarchy-beirut-theme) · [Beirut Noir](https://github.com/gaius-codius/omarchy-beirut-noir-theme)
